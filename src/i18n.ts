...
export const it = {
  ...
  toccaPunto: 'Trascina · zoom · tocca. ISS = stazione spaziale.',
  toccaCatalogo: 'Sopra di te = cosa passa ora sulla tua testa.',
  catalogoHint: 'Tocca una riga per vederla sul globo.',
  vaiIss: 'ISS',
  centraIss: 'Centra ISS',
  sopraDiTe: 'Sopra di te',
  miaPosizione: 'La mia posizione',
  centraPosizione: 'Centra sulla mia posizione e mostra i satelliti alti',
  permessoPosizione:
    'Orbita usa la tua posizione solo per mostrare quali satelliti passano sopra di te in questo momento.',
  posizioneNegata:
    'Senza posizione non posso dirti cosa c’è sopra di te. Riprova, apri Impostazioni, o scegli una città.',
  posizioneErrore: 'Non riesco a leggere la posizione. Riprova o scegli una città.',
  posizioneInCorso: 'Cerco la tua posizione…',
  riprovaPosizione: 'Riprova posizione',
  apriImpostazioni: 'Apri Impostazioni',
  usaCitta: 'Oppure una città',
  live: 'live',
  nessunoAlto: 'Nessuno sopra i 30° ora. I più alti:',
  nessunoOrizzonte: 'Nessun satellite del catalogo è sopra l’orizzonte ora.',
  nelCielo: 'Nel cielo',
  direzione: 'Direzione',
  citta: 'città',
  quota: 'Quota',
  ...
  aboutPropBody:
    'Le posizioni sono propagate all’istante corrente con il modello SGP4 (libreria satellite.js). Da una posizione, l’altezza nel cielo e la direzione usano le look angles della stessa libreria. I TLE pubblici invecchiano: sono stime, non un tracking operativo.',
  ...
  aboutPrivacyBody:
    'L’app chiede i TLE in HTTPS alle fonti sopra. La posizione (quando la concedi) resta sul telefono e serve solo a calcolare cosa passa sopra di te. Non c’è account, non c’è analytics di terze parti in questo codice.',
  howToTitle: 'Come si usa',
  howToItems: [
    'Globo: trascina, zoom, tocca un punto. ISS = stazione spaziale.',
    'Sopra di te: la tua posizione e i satelliti alti ora (gradi nel cielo e direzione).',
    'Catalogo: cerca e tocca una riga per centrarla sul globo. Aggiorna riscarica i TLE.',
  ],
  versione: 'Versione',
  howToOpen:
